...
#ifndef BESTWALLET_COMPONENTS_H
#define BESTWALLET_COMPONENTS_H
...
// One size for every control in the status bar, so nothing there has to guess.
constexpr int kStatusBarButtonSize = 28;
constexpr int kStatusBarIconSize = 17;
