...
#ifndef BESTWALLET_TOR_H
#define BESTWALLET_TOR_H
...
public:
    ...
    // How far the managed daemon has got with bootstrapping, 0-100. Tor opens
    // its SOCKS port at 0%, long before it can carry traffic.
    int bootstrapPercent() const { return m_bootstrapPercent; }

    QString managedTorHost = "127.0.0.1";
    quint16 managedTorPort = 19450;
