...
QNetworkReply* Networking::getJson(QObject *parent, const QString &url, const Headers &headers) {
    if (conf()->get(Config::offlineMode).toBool()) {
        return nullptr;
    }
...
QNetworkReply* Networking::postJson(QObject *parent, const QString &url, const QJsonObject &data, const Headers &headers) {
    if (conf()->get(Config::offlineMode).toBool()) {
        return nullptr;
    }
