...
#ifndef BESTWALLET_CONFIG_H
#define BESTWALLET_CONFIG_H
...
public:
    ...
    enum ConfigKey
    {
        ...
        socks5User,
        socks5Pass,
        useLocalTor, // Prevents the wallet from starting the bundled Tor daemon
        torOnlyAllowOnion,
        ...
        // Swap
        swapApiKey,   // ChangeNOW API key; required to open and track a swap
        swapOrderId,  // Order still being tracked, so it survives a restart
    };
