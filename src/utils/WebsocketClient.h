...
#ifndef BESTWALLET_WEBSOCKETCLIENT_H
#define BESTWALLET_WEBSOCKETCLIENT_H
...
private:
    ...
    // Upstream's public websocket servers, retained deliberately: a live
    // dependency on infrastructure the project does not own, which sees when
    // this application connects and serves data the app then trusts. Replace
    // with the project's own servers when they exist.
...
#endif //BESTWALLET_WEBSOCKETCLIENT_H
