...
#ifndef BESTWALLET_NODEWIDGET_H
#define BESTWALLET_NODEWIDGET_H
...
signals:
    void connectToNode(NodeEntry node);
    void nodeSourceChanged(NodeSource nodeSource);

private:
    void showContextMenu(const QPoint &pos, const NodeEntry &node);
