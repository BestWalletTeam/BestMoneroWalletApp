...
#ifndef BESTWALLET_SETTINGSDIALOG_H
#define BESTWALLET_SETTINGSDIALOG_H
...
private:
    ...
    QStringList m_themes{constants::skinNativeDark, constants::skinNativeWhite};
    QStringList m_dateFormats{"yyyy-MM-dd", "MM-dd-yyyy", "dd-MM-yyyy"};
    QStringList m_timeFormats{"hh:mm", "hh:mm ap"};
};

#endif //BESTWALLET_SETTINGSDIALOG_H
