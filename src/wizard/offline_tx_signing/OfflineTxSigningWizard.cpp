    ...
    , m_wallet(wallet)
{
    ...
    // ClassicStyle rather than ModernStyle: Modern draws a header band out of
    // plain QWidgets that carry their own palette, so neither the stylesheet
    // nor the wizard palette can reach them and the band stayed white in the
    // dark theme.
