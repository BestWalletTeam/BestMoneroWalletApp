...
$(package)_qtcharts_sha256_hash=3fe3ed318c2a86d1417c5c29cf7494275e8fd4b537cd37453f5599c57365515c
...
define $(package)_extract_cmds
  ...
  mkdir qtcharts && \
  $(build_TAR) --no-same-owner --strip-components=1 -xf $($(package)_source_dir)/$($(package)_qtcharts_file_name) -C qtcharts && \
  mkdir qtwebsockets && \
